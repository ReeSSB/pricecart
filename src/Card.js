         ...
         <div class="card mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <ul class="fa-ul">
              ...
              <li class={props.type.phoneSupportEnabler?"":"text-muted"}><span class="fa-li"><i class={props.type.subdomainEnabler?"fas fa-check":"fas fa-times"}></i></span><b>{props.type.title==="PRO"?<>{props.type.subdomainPrefix} </>:""}</b>{props.type.subdomain}</li>
              <li class={props.type.phoneSupportEnabler?"":"text-muted"}><span class="fa-li"><i class={props.type.reportsEnabler?"fas fa-check":"fas fa-times"}></i></span>{props.type.reports}</li>
            </ul>
            {/* <div class="d-grid">
              <a href="https://react-bootstrap.github.io/components/buttons/" class="btn btn-primary text-uppercase">Button</a>
            </div> */}
            <div className="d-grid">
            <Button className='btn btn-primary text-uppercase' href="https://react-bootstrap.github.io/components/buttons/">Button</Button>
            </div>
          </div>
        </div>
      </div>
